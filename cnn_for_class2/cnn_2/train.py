...
train_txt = '../train_val/train_full_clean_no_add.txt'
val_txt = '../train_val/val_full_clean_no_add.txt'

feat_path = '/data/dengwang/audio/data/train_feature_clean'

experiments = '/data/dengwang/audio/baseline/models/class2/cnn_2/model_cnn_2_clean_no_add_B'
