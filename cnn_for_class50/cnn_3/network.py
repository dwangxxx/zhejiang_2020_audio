...
def model_resnet(num_classes,input_shape =[128,None,2], num_filters =24,wd=1e-3):
    ...
    ResidualPath = concatenate([Residual1, Residual2],axis=1)
    
    Output = resnet_layer(inputs=ResidualPath,
