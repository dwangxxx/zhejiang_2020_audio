...
experiments = '/data/dengwang/audio/baseline/models/class50/cnn_1/model_cnn_1_full_clean_B'
...
data_val, label_val = load_data_val(feat_path, val_txt, num_freq_bin, 'logmel')
...
for i in range(len(y_val)):
    max_pos = np.argmax(y_val[i])
    label_dict[max_pos] = label_val[i]
print(label_dict)
